...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://resume-roast.onrender.com/upload",
        formData,
        {
          headers: {
  ...
  const checkServerStatus = async () => {
    try {
      await axios.get("https://resume-roast.onrender.com/health");
      setIsServerUp(true);
    } catch (err) {
      setIsServerUp(false);
    }
    ...
    <div className="App">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {isLoading ? (
          ...
          <button type="submit" disabled={!isServerUp}>
            {isServerUp ? "Upload" : "Waiting for server to start..."}
          </button>
        )}
      </form>
